...
# Dynamic Ranges
MIN_SMOOTHING = 3.0   # Fast movement (Responsive)
MAX_SMOOTHING = 10.0  # Slow movement (Very Smooth)
SMOOTHING_SPEED_THRESHOLD = 200 # Pixel distance to trigger max responsiveness
...
GESTURE_COOLDOWN = 0.7 # Seconds between clicks (Debounce)
DOUBLE_CLICK_DISTANCE = 40 # Max distance for pinch

# Safety
SCREEN_MARGIN = 0 # Full camera frame used for control
FAILSAFE_FPS = 8 # Minimum FPS before pausing for safety
